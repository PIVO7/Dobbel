...
- **Archive "Dobbel 1.0 (5)"** (2026-08-04) — ondertekend en zichtbaar in
  Xcode → Window → **Organizer**. Bevat Dobbel.app (nl/en/fr), dSYM-symbolen,
  versie 1.0 (5), minimum iOS 17.0, inclusief alle bugfixes tot en met
  BUG-45, de nachtmodus, de uitgebreide statistieken en de beurtchip.
  De oudere archives (1) t/m (4) zijn achterhaald — niet uploaden.
...
3. **Uploaden**: Xcode → Window → Organizer → archive "Dobbel 1.0 (5)" →
...
- **Volgende build uploaden**: verhoog `CURRENT_PROJECT_VERSION` in
  project.yml (5 → 6), draai `xcodegen generate`, archiveer en upload opnieuw.
