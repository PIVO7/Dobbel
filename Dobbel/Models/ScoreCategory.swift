...
enum ScoreCategory: String, CaseIterable, Codable, Identifiable, Hashable {
    ...
    case smallStraight
    case largeStraight
    // De rawValue blijft "yahtzee": hij staat in de bewaarde spellen en
    // profielen van bestaande spelers.
    case dobbel = "yahtzee"
    case chance
    ...
    var title: String {
        ...
        case .dobbel: return String(localized: "Dobbel")
    ...
    static let lower: [ScoreCategory] = [
        .threeOfAKind, .fourOfAKind, .fullHouse, .smallStraight, .largeStraight, .dobbel, .chance
    ]
}
