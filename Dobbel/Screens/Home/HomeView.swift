...
struct HomeView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                // Het tafelkleed onder aan het scherm; decor achter de
                // inhoud, tot voorbij de veilige zone zodat het de rand raakt.
                VStack(spacing: 0) {
                    Spacer(minLength: 0)
                    TableclothView(scallopHeight: m.gutter * 0.55, lineWidth: m.border, height: m.gutter * 6)
                }
                .ignoresSafeArea(edges: .bottom)

                // De inhoud vult minstens het scherm, zodat de menupillen
                // net boven het kleed eindigen in plaats van halverwege.
                GeometryReader { geo in
                    ScrollView {
                        VStack(spacing: 0) {
                            // De held zakt een stukje in de kleedband: de
                            // dobbelstenen liggen óp het kleed in plaats
                            // van erboven.
                            ...
                            // zodat het menu tussen kleedband en tafel zweeft.
                            Spacer(minLength: 0)
                            ...
                            // ter hoogte van het kleed, ook als de spacers
    ...
    private func menuLabel(_ title: String, subtitle: String, tint: Color, cardFill: Color, face: Int, badge: String? = nil) -> some View {
